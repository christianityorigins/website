...
Monism is the proper cosmology of natural history, and the only logical religious system that can unite theists, polytheists, and athiests. Think of monism as an interface, a core cosmology you can plug your personal or tribal beliefs into. Monist religions are: Pythagorianism, Stoicism, Platonism, Druidism, Vedism, Sufi Islam, incorporate you beliefs and then you will have a personal operating system.
...
3\. The polytheistic framework represents an early attempt to model reality, externalize cognition, and adapt to ecology, reflecting logical human responses to complexity, and can be viewed through the lens of complex systems theory. Some polytheistic religious followers see the polytheistic deities as sentient personal gods, others see them as allegorical personifications of natural forces (numen/animism), or as monist emanations or forms/symbolic representations of a particular quality or principle. Many modern atheistic Pagans are inspired by Carl Jung who combined psychoanalysis with Heathenry; the polytheistic deities = 'archetypes of the collective unconscious' to these Pagans.
