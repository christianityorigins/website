...
Monist religions are: Pythagorianism, Stocism, Platonism, Druidism (2), Vedism, Sufi Islam (Wahdat al-Wujud" which translates to "the unity of existence" or "the oneness of being").
...
Monism offers a simple and elegant explanation for the complexity of the universe. By positing the existence of a single, underlying reality, monism provides a unified framework for understanding the natural world. Monist religions also have the broadest appeal; they appeal to atheists, theists, polytheists, et.al. The important thing is that monism serves as a logical core for a religion that functions as a cultural taxonomy, provides a shared cultural heritage, community and social network, and tradition. \
